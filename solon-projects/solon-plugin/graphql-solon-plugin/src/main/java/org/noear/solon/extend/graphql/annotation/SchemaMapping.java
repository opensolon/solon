...
/**
 * copy from org.springframework.graphql.data.method.annotation.SchemaMapping
 *
 ...
 * which case all handlers methods inherit the class-level typeName by default unless overridden at
 * the method level.
 *
