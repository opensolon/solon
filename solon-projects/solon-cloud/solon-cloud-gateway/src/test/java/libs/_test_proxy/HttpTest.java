...
public class HttpTest extends HttpTester {
    ...
    public void test12_get() throws IOException {
        assert path("/demo1/run1/*").get().contains("/demo1/run1/*");
    }
    ...
    public void test14() throws IOException {
        assert path("/demo1/run2/send").get().contains("/demo1/run2/send");
    }

    @Test
    public void test15() throws IOException {
        assert path("/demo1/run2/test").get().contains("/demo1/run2/test");
    }
