...
public class GroupedQuery8<Key, T1, T2, T3, T4, T5, T6, T7, T8> extends QueryBase {
    ...
    public <R extends Number> R sum(ExprTree<Func8<T1, T2, T3, T4, T5, T6, T7, T8, R>> expr) {
    ...
    public <R extends Number> BigDecimal avg(ExprTree<Func8<T1, T2, T3, T4, T5, T6, T7, T8, R>> expr) {
    ...
    public <R extends Number> R max(ExprTree<Func8<T1, T2, T3, T4, T5, T6, T7, T8, R>> expr) {
    ...
    public <R extends Number> R min(ExprTree<Func8<T1, T2, T3, T4, T5, T6, T7, T8, R>> expr) {
