...
import org.noear.solon.data.sqlink.api.crud.read.group.GroupedQuery4;
...
public class LQuery4<T1, T2, T3, T4> extends QueryBase {
    ...
    public <Tn> LQuery5<T1, T2, T3, T4, Tn> innerJoinWith(LQuery<Tn> target, @Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, Tn, Boolean> func) {
        throw new NotCompiledException();
    }

    public <Tn> LQuery5<T1, T2, T3, T4, Tn> innerJoinWith(LQuery<Tn> target, ExprTree<Func5<T1, T2, T3, T4, Tn, Boolean>> expr) {
    ...
    public <Tn> LQuery5<T1, T2, T3, T4, Tn> leftJoinWith(LQuery<Tn> target, @Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, Tn, Boolean> func) {
        throw new NotCompiledException();
    }

    public <Tn> LQuery5<T1, T2, T3, T4, Tn> leftJoinWith(LQuery<Tn> target, ExprTree<Func5<T1, T2, T3, T4, Tn, Boolean>> expr) {
    ...
    public <Tn> LQuery5<T1, T2, T3, T4, Tn> rightJoinWith(LQuery<Tn> target, @Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, Tn, Boolean> func) {
        throw new NotCompiledException();
    }

    public <Tn> LQuery5<T1, T2, T3, T4, Tn> rightJoinWith(LQuery<Tn> target, ExprTree<Func5<T1, T2, T3, T4, Tn, Boolean>> expr) {
    ...
    public LQuery4<T1, T2, T3, T4> whereIf(boolean condition, @Expr(Expr.BodyType.Expr) Func4<T1, T2, T3, T4, Boolean> func) {
        throw new NotCompiledException();
    }

    public LQuery4<T1, T2, T3, T4> whereIf(boolean condition, ExprTree<Func4<T1, T2, T3, T4, Boolean>> expr) {
    ...
    public LQuery4<T1, T2, T3, T4> orWhereIf(boolean condition, @Expr(Expr.BodyType.Expr) Func4<T1, T2, T3, T4, Boolean> func) {
        throw new NotCompiledException();
    }

    public LQuery4<T1, T2, T3, T4> orWhereIf(boolean condition, ExprTree<Func4<T1, T2, T3, T4, Boolean>> expr) {
    ...
    public <R> LQuery4<T1, T2, T3, T4> orderByDesc(@Expr(Expr.BodyType.Expr) Func4<T1, T2, T3, T4, R> expr) {
        throw new NotCompiledException();
    }

    public <R> LQuery4<T1, T2, T3, T4> orderByDesc(ExprTree<Func4<T1, T2, T3, T4, R>> expr) {
        orderBy(expr, false);
        return this;
    }

    public <R> LQuery4<T1, T2, T3, T4> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func4<T1, T2, T3, T4, R> expr, boolean asc) {
        throw new NotCompiledException();
    }

    public <R> LQuery4<T1, T2, T3, T4> orderByIf(boolean condition, ExprTree<Func4<T1, T2, T3, T4, R>> expr, boolean asc) {
        if (condition) orderBy(expr.getTree(), asc);
        return this;
    }

    public <R> LQuery4<T1, T2, T3, T4> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func4<T1, T2, T3, T4, R> expr) {
        throw new NotCompiledException();
    }

    public <R> LQuery4<T1, T2, T3, T4> orderByIf(boolean condition, ExprTree<Func4<T1, T2, T3, T4, R>> expr) {
        if (condition) orderBy(expr, true);
        return this;
    }

    public <R> LQuery4<T1, T2, T3, T4> orderByDescIf(boolean condition, @Expr(Expr.BodyType.Expr) Func4<T1, T2, T3, T4, R> expr) {
        throw new NotCompiledException();
    }

    public <R> LQuery4<T1, T2, T3, T4> orderByDescIf(boolean condition, ExprTree<Func4<T1, T2, T3, T4, R>> expr) {
     ...
     * @return this
     */
    public LQuery4<T1, T2, T3, T4> limitIf(boolean condition, long rows) {
     ...
     * @return this
     */
    public LQuery4<T1, T2, T3, T4> limitIf(boolean condition, long offset, long rows) {
     ...
     * @return 分组查询过程对象
     */
    public <Key extends Grouper> GroupedQuery4<? extends Key, T1, T2, T3, T4> groupBy(@Expr Func4<T1, T2, T3, T4, Key> expr) {
        throw new NotCompiledException();
    }

    public <Key extends Grouper> GroupedQuery4<? extends Key, T1, T2, T3, T4> groupBy(ExprTree<Func4<T1, T2, T3, T4, Key>> expr) {
     ...
     */
    public <R extends Result> LQuery<? extends R> select(@Expr(Expr.BodyType.Expr) Func4<T1, T2, T3, T4, R> expr) {
        throw new NotCompiledException();
    }

    public <R extends Result> LQuery<? extends R> select(ExprTree<Func4<T1, T2, T3, T4, R>> expr) {
