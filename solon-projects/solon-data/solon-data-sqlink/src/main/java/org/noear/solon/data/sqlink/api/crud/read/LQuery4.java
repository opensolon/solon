...
public class LQuery4<T1, T2, T3, T4> extends QueryBase {
     ...
     * @return this
     */
    public <E> LQuery4<T1, T2, T3, T4> exists(Class<E> target, @Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, E, Boolean> func) {
        throw new NotCompiledException();
    }
     ...
     * @return this
     */
    public <E> LQuery4<T1, T2, T3, T4> exists(LQuery<E> target, @Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, E, Boolean> func) {
        throw new NotCompiledException();
    }
     ...
     * @return this
     */
    public <E> LQuery4<T1, T2, T3, T4> notExists(Class<E> target, @Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, E, Boolean> func) {
        throw new NotCompiledException();
    }
     ...
     * @return this
     */
    public <E> LQuery4<T1, T2, T3, T4> notExists(LQuery<E> target, @Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, E, Boolean> func) {
        throw new NotCompiledException();
    }
     ...
     */
    public <R extends Result> LQuery<? extends R> select(@Expr Func4<T1, T2, T3, T4, R> expr) {
        throw new NotCompiledException();
    }
