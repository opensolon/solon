...
public class LUpdate5<T1, T2, T3, T4, T5> extends UpdateBase {
    ...
    public <R> LUpdate5<T1, T2, T3, T4, T5> setInDb(@Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, T5, R> func, Func5<T1, T2, T3, T4, T5, R> value) {
        throw new NotCompiledException();
    }

    public <R> LUpdate5<T1, T2, T3, T4, T5> setInDb(ExprTree<Func5<T1, T2, T3, T4, T5, R>> func, ExprTree<Func5<T1, T2, T3, T4, T5, R>> value) {
    ...
    public <R> LUpdate5<T1, T2, T3, T4, T5> setInDbIf(boolean condition, @Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, T5, R> func, Func5<T1, T2, T3, T4, T5, R> value) {
        throw new NotCompiledException();
    }

    public <R> LUpdate5<T1, T2, T3, T4, T5> setInDbIf(boolean condition, ExprTree<Func5<T1, T2, T3, T4, T5, R>> func, ExprTree<Func5<T1, T2, T3, T4, T5, R>> value) {
