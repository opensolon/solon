...
public class LQuery7<T1, T2, T3, T4, T5, T6, T7> extends QueryBase
{
     ...
     * @return this
     */
    public <E> LQuery7<T1, T2, T3, T4, T5, T6, T7> exists(Class<E> target, @Expr(Expr.BodyType.Expr) Func8<T1, T2, T3, T4, T5, T6, T7, E, Boolean> func)
    {
        throw new NotCompiledException();
    }
     ...
     * @return this
     */
    public <E> LQuery7<T1, T2, T3, T4, T5, T6, T7> exists(LQuery<E> target, @Expr(Expr.BodyType.Expr) Func8<T1, T2, T3, T4, T5, T6, T7, E, Boolean> func)
    {
        throw new NotCompiledException();
    }
     ...
     * @return this
     */
    public <E> LQuery7<T1, T2, T3, T4, T5, T6, T7> notExists(Class<E> target, @Expr(Expr.BodyType.Expr) Func8<T1, T2, T3, T4, T5, T6, T7, E, Boolean> func)
    {
        throw new NotCompiledException();
    }
     ...
     * @return this
     */
    public <E> LQuery7<T1, T2, T3, T4, T5, T6, T7> notExists(LQuery<E> target, @Expr(Expr.BodyType.Expr) Func8<T1, T2, T3, T4, T5, T6, T7, E, Boolean> func)
    {
        throw new NotCompiledException();
    }
     ...
     * @return 分组查询过程对象
     */
    public <Key extends Grouper> GroupedQuery7<Key, T1, T2, T3, T4, T5, T6, T7> groupBy(@Expr Func7<T1, T2, T3, T4, T5, T6, T7, Key> expr)
    {
        throw new NotCompiledException();
    }

    public <Key extends Grouper> GroupedQuery7<Key, T1, T2, T3, T4, T5, T6, T7> groupBy(ExprTree<Func7<T1, T2, T3, T4, T5, T6, T7, Key>> expr)
    {
     ...
     */
    public <R extends Result> LQuery<R> select(@Expr Func7<T1, T2, T3, T4, T5, T6, T7, R> expr)
    {
        throw new NotCompiledException();
    }

    public <R extends Result> LQuery<R> select(ExprTree<Func7<T1, T2, T3, T4, T5, T6, T7, R>> expr)
    {
