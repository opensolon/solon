...
import org.noear.solon.data.sqlink.api.crud.read.group.GroupedQuery5;
...
public class LQuery5<T1, T2, T3, T4, T5> extends QueryBase {
    ...
    public <R> LQuery5<T1, T2, T3, T4, T5> orderByDesc(@Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, T5, R> expr) {
        throw new NotCompiledException();
    }

    public <R> LQuery5<T1, T2, T3, T4, T5> orderByDesc(ExprTree<Func5<T1, T2, T3, T4, T5, R>> expr) {
        orderBy(expr, false);
        return this;
    }

    public <R> LQuery5<T1, T2, T3, T4, T5> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, T5, R> expr, boolean asc) {
        throw new NotCompiledException();
    }

    public <R> LQuery5<T1, T2, T3, T4, T5> orderByIf(boolean condition, ExprTree<Func5<T1, T2, T3, T4, T5, R>> expr, boolean asc) {
        if (condition) orderBy(expr.getTree(), asc);
        return this;
    }

    public <R> LQuery5<T1, T2, T3, T4, T5> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, T5, R> expr) {
        throw new NotCompiledException();
    }

    public <R> LQuery5<T1, T2, T3, T4, T5> orderByIf(boolean condition, ExprTree<Func5<T1, T2, T3, T4, T5, R>> expr) {
        if (condition) orderBy(expr, true);
        return this;
    }

    public <R> LQuery5<T1, T2, T3, T4, T5> orderByDescIf(boolean condition, @Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, T5, R> expr) {
        throw new NotCompiledException();
    }

    public <R> LQuery5<T1, T2, T3, T4, T5> orderByDescIf(boolean condition, ExprTree<Func5<T1, T2, T3, T4, T5, R>> expr) {
     ...
     * @return this
     */
    public LQuery5<T1, T2, T3, T4, T5> limitIf(boolean condition, long rows) {
     ...
     * @return this
     */
    public LQuery5<T1, T2, T3, T4, T5> limitIf(boolean condition, long offset, long rows) {
     ...
     */
    public <R extends Result> LQuery<? extends R> select(@Expr(Expr.BodyType.Expr) Func5<T1, T2, T3, T4, T5, R> expr) {
        throw new NotCompiledException();
    }
