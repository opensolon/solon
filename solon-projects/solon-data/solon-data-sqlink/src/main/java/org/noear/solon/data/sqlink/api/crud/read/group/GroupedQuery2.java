...
public class GroupedQuery2<Key, T1, T2> extends QueryBase {
     ...
     */
    public <R> long count(Func2<T1, T2, R> func) {
        throw new NotCompiledException();
    }
     ...
     */
    public <R extends Number> R sum(Func2<T1, T2, R> func) {
        throw new NotCompiledException();
    }
     ...
     * @param func 返回需要统计的字段的lambda表达式(强制要求参数为<b>lambda表达式</b>，不可以是<span style='color:red;'>方法引用</span>以及<span style='color:red))
     */
    public <R extends Number> BigDecimal avg(Func2<T1, T2, R> func) {
        throw new NotCompiledException();
    }
     ...
     * @param func 返回需要统计的字段的lambda表达式(强制要求参数为<b>lambda表达式</b>，不可以是<span style='color:red;'>方法引用</span>以及<span style='color:red)))
     */
    public <R extends Number> R max(Func2<T1, T2, R> func) {
        throw new NotCompiledException();
    }
     ...
     * @param func 返回需要统计的字段的lambda表达式(强制要求参数为<b>lambda表达式</b>，不可以是<span style='color:red;'>方法引用</span>以及<span style='color:red)))
     */
    public <R extends Number> R min(Func2<T1, T2, R> func) {
        throw new NotCompiledException();
    }
