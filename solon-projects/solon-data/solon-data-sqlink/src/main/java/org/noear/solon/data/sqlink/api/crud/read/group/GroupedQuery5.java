...
public class GroupedQuery5<Key, T1, T2, T3, T4, T5> extends QueryBase {
     ...
     */
    public <R extends Result> LQuery<? extends R> select(@Expr Func1<Group5<Key, T1, T2, T3, T4, T5>, R> expr) {
        throw new NotCompiledException();
    }
    ...
    public <R extends Number> R sum(ExprTree<Func5<T1, T2, T3, T4, T5, R>> expr) {
    ...
    public <R extends Number> BigDecimal avg(ExprTree<Func5<T1, T2, T3, T4, T5, R>> expr) {
    ...
    public <R extends Number> R max(ExprTree<Func5<T1, T2, T3, T4, T5, R>> expr) {
    ...
    public <R extends Number> R min(ExprTree<Func5<T1, T2, T3, T4, T5, R>> expr) {
