...
public class GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> extends QueryBase
{
    ...
    // region [SELECT]
    public <R extends Result> LQuery<R> select(@Expr Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R> expr)
    {
        throw new NotCompiledException();
    }

    public <R extends Result> LQuery<R> select(ExprTree<Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R>> expr)
    {
