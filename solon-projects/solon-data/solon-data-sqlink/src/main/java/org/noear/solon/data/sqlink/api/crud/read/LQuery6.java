...
public class LQuery6<T1, T2, T3, T4, T5, T6> extends QueryBase {
    ...
    public <Tn> LQuery7<T1, T2, T3, T4, T5, T6, Tn> innerJoinWith(LQuery<Tn> target, @Expr(Expr.BodyType.Expr) Func7<T1, T2, T3, T4, T5, T6, Tn, Boolean> func) {
        throw new NotCompiledException();
    }

    public <Tn> LQuery7<T1, T2, T3, T4, T5, T6, Tn> innerJoinWith(LQuery<Tn> target, ExprTree<Func7<T1, T2, T3, T4, T5, T6, Tn, Boolean>> expr) {
    ...
    public <Tn> LQuery7<T1, T2, T3, T4, T5, T6, Tn> leftJoinWith(LQuery<Tn> target, @Expr(Expr.BodyType.Expr) Func7<T1, T2, T3, T4, T5, T6, Tn, Boolean> func) {
        throw new NotCompiledException();
    }

    public <Tn> LQuery7<T1, T2, T3, T4, T5, T6, Tn> leftJoinWith(LQuery<Tn> target, ExprTree<Func7<T1, T2, T3, T4, T5, T6, Tn, Boolean>> expr) {
    ...
    public <Tn> LQuery7<T1, T2, T3, T4, T5, T6, Tn> rightJoinWith(LQuery<Tn> target, @Expr(Expr.BodyType.Expr) Func7<T1, T2, T3, T4, T5, T6, Tn, Boolean> func) {
        throw new NotCompiledException();
    }

    public <Tn> LQuery7<T1, T2, T3, T4, T5, T6, Tn> rightJoinWith(LQuery<Tn> target, ExprTree<Func7<T1, T2, T3, T4, T5, T6, Tn, Boolean>> expr) {
    ...
    public LQuery6<T1, T2, T3, T4, T5, T6> whereIf(boolean condition, @Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, Boolean> func) {
        throw new NotCompiledException();
    }

    public LQuery6<T1, T2, T3, T4, T5, T6> whereIf(boolean condition, ExprTree<Func6<T1, T2, T3, T4, T5, T6, Boolean>> expr) {
    ...
    public LQuery6<T1, T2, T3, T4, T5, T6> orWhereIf(boolean condition, @Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, Boolean> func) {
        throw new NotCompiledException();
    }

    public LQuery6<T1, T2, T3, T4, T5, T6> orWhereIf(boolean condition, ExprTree<Func6<T1, T2, T3, T4, T5, T6, Boolean>> expr) {
    ...
    public <R> LQuery6<T1, T2, T3, T4, T5, T6> orderByDesc(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr) {
        throw new NotCompiledException();
    }

    public <R> LQuery6<T1, T2, T3, T4, T5, T6> orderByDesc(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
        orderBy(expr, false);
        return this;
    }

    public <R> LQuery6<T1, T2, T3, T4, T5, T6> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr, boolean asc) {
        throw new NotCompiledException();
    }

    public <R> LQuery6<T1, T2, T3, T4, T5, T6> orderByIf(boolean condition, ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr, boolean asc) {
        if (condition) orderBy(expr.getTree(), asc);
        return this;
    }

    public <R> LQuery6<T1, T2, T3, T4, T5, T6> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr) {
        throw new NotCompiledException();
    }

    public <R> LQuery6<T1, T2, T3, T4, T5, T6> orderByIf(boolean condition, ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
        if (condition) orderBy(expr, true);
        return this;
    }

    public <R> LQuery6<T1, T2, T3, T4, T5, T6> orderByDescIf(boolean condition, @Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr) {
        throw new NotCompiledException();
    }

    public <R> LQuery6<T1, T2, T3, T4, T5, T6> orderByDescIf(boolean condition, ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
     ...
     * @return this
     */
    public LQuery6<T1, T2, T3, T4, T5, T6> limitIf(boolean condition, long rows) {
     ...
     * @return this
     */
    public LQuery6<T1, T2, T3, T4, T5, T6> limitIf(boolean condition, long offset, long rows) {
     ...
     */
    public <R extends Result> LQuery<? extends R> select(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr) {
        throw new NotCompiledException();
    }
