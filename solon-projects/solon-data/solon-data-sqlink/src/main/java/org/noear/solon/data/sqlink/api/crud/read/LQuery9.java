...
import org.noear.solon.data.sqlink.api.crud.read.group.GroupedQuery9;
...
public class LQuery9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends QueryBase {
     ...
     * @return this
     */
    public <E> LQuery9<T1, T2, T3, T4, T5, T6, T7, T8, T9> exists(Class<E> target, @Expr(Expr.BodyType.Expr) Func10<T1, T2, T3, T4, T5, T6, T7, T8, T9, E, Boolean> func) {
        throw new NotCompiledException();
    }
     ...
     * @return this
     */
    public <E> LQuery9<T1, T2, T3, T4, T5, T6, T7, T8, T9> exists(LQuery<E> target, @Expr(Expr.BodyType.Expr) Func10<T1, T2, T3, T4, T5, T6, T7, T8, T9, E, Boolean> func) {
        throw new NotCompiledException();
    }
     ...
     * @return this
     */
    public <E> LQuery9<T1, T2, T3, T4, T5, T6, T7, T8, T9> notExists(Class<E> target, @Expr(Expr.BodyType.Expr) Func10<T1, T2, T3, T4, T5, T6, T7, T8, T9, E, Boolean> func) {
        throw new NotCompiledException();
    }
     ...
     * @return this
     */
    public <E> LQuery9<T1, T2, T3, T4, T5, T6, T7, T8, T9> notExists(LQuery<E> target, @Expr(Expr.BodyType.Expr) Func10<T1, T2, T3, T4, T5, T6, T7, T8, T9, E, Boolean> func) {
        throw new NotCompiledException();
    }
     ...
     */
    public <R extends Result> LQuery<? extends R> select(@Expr Func9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> expr) {
        throw new NotCompiledException();
    }
