...
public class GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> extends QueryBase {
     ...
     */
    public <R> long count(Func6<T1, T2, T3, T4, T5, T6, R> func) {
        throw new NotCompiledException();
    }
     ...
     */
    public <R extends Number> R sum(Func6<T1, T2, T3, T4, T5, T6, R> func) {
        throw new NotCompiledException();
    }
     ...
     * @param func 返回需要统计的字段的lambda表达式(强制要求参数为<b>lambda表达式</b>，不可以是<span style='color:red;'>方法引用</span>以及<span style='color:red))
     */
    public <R extends Number> BigDecimal avg(Func6<T1, T2, T3, T4, T5, T6, R> func) {
        throw new NotCompiledException();
    }
     ...
     * @param func 返回需要统计的字段的lambda表达式(强制要求参数为<b>lambda表达式</b>，不可以是<span style='color:red;'>方法引用</span>以及<span style='color:red)))
     */
    public <R extends Number> R max(Func6<T1, T2, T3, T4, T5, T6, R> func) {
        throw new NotCompiledException();
    }
     ...
     * @param func 返回需要统计的字段的lambda表达式(强制要求参数为<b>lambda表达式</b>，不可以是<span style='color:red;'>方法引用</span>以及<span style='color:red)))
     */
    public <R extends Number> R min(Func6<T1, T2, T3, T4, T5, T6, R> func) {
        throw new NotCompiledException();
    }
