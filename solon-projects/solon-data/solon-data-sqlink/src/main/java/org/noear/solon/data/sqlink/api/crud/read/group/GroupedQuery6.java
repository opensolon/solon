...
public class GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> extends QueryBase {
    ...
    public <R extends Number> R sum(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
    ...
    public <R extends Number> BigDecimal avg(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
    ...
    public <R extends Number> R max(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
    ...
    public <R extends Number> R min(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
