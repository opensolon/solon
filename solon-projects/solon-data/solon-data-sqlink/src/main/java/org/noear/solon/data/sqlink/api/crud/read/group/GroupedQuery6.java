...
public class GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> extends QueryBase {
    ...
    public GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> havingIf(boolean condition, @Expr(Expr.BodyType.Expr) Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, Boolean> func) {
        throw new NotCompiledException();
    }

    public GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> havingIf(boolean condition, ExprTree<Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, Boolean>> expr) {
    ...
    public <R> GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> orderByDesc(@Expr(Expr.BodyType.Expr) Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R> expr) {
        throw new NotCompiledException();
    }

    public <R> GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> orderByDesc(ExprTree<Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R>> expr) {
        orderBy(expr, false);
        return this;
    }

    public <R> GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R> expr, boolean asc) {
        throw new NotCompiledException();
    }

    public <R> GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> orderByIf(boolean condition, ExprTree<Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R>> expr, boolean asc) {
        if (condition) orderBy(expr.getTree(), asc);
        return this;
    }

    public <R> GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R> expr) {
        throw new NotCompiledException();
    }

    public <R> GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> orderByIf(boolean condition, ExprTree<Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R>> expr) {
        if (condition) orderBy(expr, true);
        return this;
    }

    public <R> GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> orderByDescIf(boolean condition, @Expr(Expr.BodyType.Expr) Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R> expr) {
        throw new NotCompiledException();
    }

    public <R> GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> orderByDescIf(boolean condition, ExprTree<Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R>> expr) {
     ...
     * @return this
     */
    public GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> limitIf(boolean condition, long rows) {
     ...
     * @return this
     */
    public GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> limitIf(boolean condition, long offset, long rows) {
     ...
     */
    public <R extends Result> LQuery<? extends R> select(@Expr(Expr.BodyType.Expr) Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R> expr) {
        throw new NotCompiledException();
    }

    public <R extends Result> LQuery<? extends R> select(ExprTree<Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R>> expr) {
     ...
     * <b>注意：此函数的ExprTree[func类型]版本为真正被调用的函数
     */
    public boolean any(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, Boolean> func) {
        throw new NotCompiledException();
    }

    public boolean any(ExprTree<Func6<T1, T2, T3, T4, T5, T6, Boolean>> expr) {
     ...
     */
    public <R> List<Long> count(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> func) {
        throw new NotCompiledException();
    }

    public <R> List<Long> count(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
     ...
     */
    public <R extends Number> List<R> sum(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> func) {
        throw new NotCompiledException();
    }

    public <R extends Number> List<R> sum(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
     ...
     * @param func 返回需要统计的字段的lambda表达式(强制要求参数为<b>lambda表达式</b>，不可以是<span style='color:red;'>方法引用</span>以及<span style='color:red))
     */
    public <R extends Number> List<BigDecimal> avg(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> func) {
        throw new NotCompiledException();
    }

    public <R extends Number> List<BigDecimal> avg(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
     ...
     * @param func 返回需要统计的字段的lambda表达式(强制要求参数为<b>lambda表达式</b>，不可以是<span style='color:red;'>方法引用</span>以及<span style='color:red)))
     */
    public <R extends Number> List<R> max(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> func) {
        throw new NotCompiledException();
    }

    public <R extends Number> List<R> max(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
     ...
     * @param func 返回需要统计的字段的lambda表达式(强制要求参数为<b>lambda表达式</b>，不可以是<span style='color:red;'>方法引用</span>以及<span style='color:red)))
     */
    public <R extends Number> List<R> min(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> func) {
        throw new NotCompiledException();
    }

    public <R extends Number> List<R> min(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
