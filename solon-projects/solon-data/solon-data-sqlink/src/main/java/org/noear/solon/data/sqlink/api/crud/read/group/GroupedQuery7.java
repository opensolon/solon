...
public class GroupedQuery7<Key, T1, T2, T3, T4, T5, T6, T7> extends QueryBase {
     ...
     * @return this
     */
    public GroupedQuery7<Key, T1, T2, T3, T4, T5, T6, T7> limitIf(boolean condition, long rows) {
     ...
     * @return this
     */
    public GroupedQuery7<Key, T1, T2, T3, T4, T5, T6, T7> limitIf(boolean condition, long offset, long rows) {
     ...
     */
    public <R extends Result> LQuery<? extends R> select(@Expr(Expr.BodyType.Expr) Func1<Group7<Key, T1, T2, T3, T4, T5, T6, T7>, R> expr) {
        throw new NotCompiledException();
    }
