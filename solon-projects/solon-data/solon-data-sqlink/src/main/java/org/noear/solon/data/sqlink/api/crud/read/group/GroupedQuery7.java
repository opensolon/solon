...
public class GroupedQuery7<Key, T1, T2, T3, T4, T5, T6, T7> extends QueryBase {
     ...
     */
    public <R extends Result> LQuery<? extends R> select(@Expr Func1<Group7<Key, T1, T2, T3, T4, T5, T6, T7>, R> expr) {
        throw new NotCompiledException();
    }

    public <R extends Result> LQuery<? extends R> select(ExprTree<Func1<Group7<Key, T1, T2, T3, T4, T5, T6, T7>, R>> expr) {
     ...
     */
    public <R> long count(Func7<T1, T2, T3, T4, T5, T6, T7, R> func) {
        throw new NotCompiledException();
    }

    public <R> long count(ExprTree<Func7<T1, T2, T3, T4, T5, T6, T7, R>> expr) {
     ...
     */
    public <R extends Number> R sum(Func7<T1, T2, T3, T4, T5, T6, T7, R> func) {
        throw new NotCompiledException();
    }

    public <R extends Number> R sum(ExprTree<Func7<T1, T2, T3, T4, T5, T6, T7, R>> expr) {
     ...
     * @param func 返回需要统计的字段的lambda表达式(强制要求参数为<b>lambda表达式</b>，不可以是<span style='color:red;'>方法引用</span>以及<span style='color:red))
     */
    public <R extends Number> BigDecimal avg(Func7<T1, T2, T3, T4, T5, T6, T7, R> func) {
        throw new NotCompiledException();
    }

    public <R extends Number> BigDecimal avg(ExprTree<Func7<T1, T2, T3, T4, T5, T6, T7, R>> expr) {
     ...
     * @param func 返回需要统计的字段的lambda表达式(强制要求参数为<b>lambda表达式</b>，不可以是<span style='color:red;'>方法引用</span>以及<span style='color:red)))
     */
    public <R extends Number> R max(Func7<T1, T2, T3, T4, T5, T6, T7, R> func) {
        throw new NotCompiledException();
    }

    public <R extends Number> R max(ExprTree<Func7<T1, T2, T3, T4, T5, T6, T7, R>> expr) {
     ...
     * @param func 返回需要统计的字段的lambda表达式(强制要求参数为<b>lambda表达式</b>，不可以是<span style='color:red;'>方法引用</span>以及<span style='color:red)))
     */
    public <R extends Number> R min(Func7<T1, T2, T3, T4, T5, T6, T7, R> func) {
        throw new NotCompiledException();
    }

    public <R extends Number> R min(ExprTree<Func7<T1, T2, T3, T4, T5, T6, T7, R>> expr) {
