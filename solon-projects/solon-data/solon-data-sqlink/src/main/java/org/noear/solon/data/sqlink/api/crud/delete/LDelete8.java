...
public class LDelete8<T1, T2, T3, T4, T5, T6, T7, T8> extends DeleteBase {
    ...
    public LDelete8<T1, T2, T3, T4, T5, T6, T7, T8> whereIf(boolean condition, @Expr Func8<T1, T2, T3, T4, T5, T6, T7, T8, Boolean> func) {
        throw new NotCompiledException();
    }

    public LDelete8<T1, T2, T3, T4, T5, T6, T7, T8> whereIf(boolean condition, ExprTree<Func8<T1, T2, T3, T4, T5, T6, T7, T8, Boolean>> expr) {
