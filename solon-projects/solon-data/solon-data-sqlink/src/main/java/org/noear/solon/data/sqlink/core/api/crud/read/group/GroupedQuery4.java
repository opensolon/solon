...
public class GroupedQuery4<Key, T1, T2, T3, T4> extends QueryBase
{
    ...
    // region [SELECT]
    public <R extends Result> LQuery<R> select(@Expr Func1<Group4<Key, T1, T2, T3, T4>, R> expr)
    {
        throw new NotCompiledException();
    }

    public <R extends Result> LQuery<R> select(ExprTree<Func1<Group4<Key, T1, T2, T3, T4>, R>> expr)
    {
