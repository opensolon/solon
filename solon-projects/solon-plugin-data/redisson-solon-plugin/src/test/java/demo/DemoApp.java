...
public class DemoApp {
    public static void main(String[] args){
        AopContext context = Solon.start(DemoApp.class, args).context();
        RedissonClient demo1 = context.getBean(RedissonClient.class);
        ...
        RedissonClient demo2 = context.getBean("demo2");
