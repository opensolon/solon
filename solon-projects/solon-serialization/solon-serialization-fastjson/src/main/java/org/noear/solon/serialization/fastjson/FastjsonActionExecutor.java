 ...
 */
@Deprecated
public class FastjsonActionExecutor implements ActionExecuteHandler {
    private final FastjsonEntityConverter entityConverter;

    public FastjsonActionExecutor(FastjsonEntityConverter entityConverter) {
