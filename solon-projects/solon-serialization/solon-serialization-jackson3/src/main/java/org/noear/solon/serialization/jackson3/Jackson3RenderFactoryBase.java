 ...
 * */
@Deprecated
public abstract class Jackson3RenderFactoryBase implements JsonRenderFactory {
    protected final Jackson3StringSerializer serializer;

    public Jackson3RenderFactoryBase(Jackson3StringSerializer serializer) {
