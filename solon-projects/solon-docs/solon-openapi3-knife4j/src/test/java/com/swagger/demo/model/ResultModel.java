...
public class ResultModel {
    ...
    @Schema(description = "错误码", example = "-1", required = true)
    private String errorCode;

    @Schema(description = "错误信息", example = "错误信息")
    private String errorMessage;

    @Schema(description = "前端错误处理： 0 silent; 1 message.warn; 2 message.error; 4 notification; 9 page",
            example = "2")
    private int showType;

    @Schema(description = "方便后端故障排除：唯一请求ID", example = "someid")
    private String traceId;

    @Schema(description = "当前访问服务器的主机", example = "127.0.0.1")
    private String host;

    @Schema(description = "测试long[]")
