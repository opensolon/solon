...
| 组件 | 说明 |
| --- | --- |
| org.noear:solon-parent:1.0.3.7 | 框架版本管理 |
| org.noear:solon:1.0.3.7 | 70k，主框架 |
...
| org.noear:solon.serialization.snack3:1.0.3.1 | 61kb，视图插件，对 snack3 适配，输出json视图 或 序列化输出 |
