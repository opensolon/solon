 ...
 * @since 1.10.7
 */
public class SolonMapperGenerator extends BaseModelGenerator {
    private String modelPacket;
    private String basePackage;
    private String classSuffix = "Mapper";
    private String classPrefix = "";
    private String engineName = "forDao" + new Random().nextInt();

    private MetaBuilder metaBuilder;

    public SolonMapperGenerator(DataSource dataSource, String daoPackageName, String baseOutputDir, String modelPacket) {
        super(daoPackageName, baseOutputDir);

        this.modelPacket = modelPacket;

        this.template = "/org/noear/solon/extend/activerecord/generator/mapper_template.tp";
        this.metaBuilder = new MetaBuilder(dataSource);
    }

    public SolonMapperGenerator addExcludedTable(String... excludedTables) {
        this.metaBuilder.addExcludedTable(excludedTables);
        return this;
    }

    public SolonMapperGenerator addWhitelist(String... tableNames) {
        if (tableNames != null) {
    ...
    public void generate(List<TableMeta> tableMetas) {
        ...
        System.out.println("Dao Output Dir: " + this.baseModelOutputDir);
    ...
    public SolonMapperGenerator setClassPrefix(String classPrefix) {
        this.classPrefix = classPrefix;
        return this;
    }

    public SolonMapperGenerator setClassSuffix(String classSuffix) {
     ...
     */
    public SolonMapperGenerator setRemovedTableNamePrefixes(String... prefixes) {
