...
**Solon** — эффективная система разработки приложений Java; Кроме того, существует обширная открытая экология плагинов, которые комбинируют различные плагины для решения различных потребностей; Удобно настраивать; Быстрое развитие:
