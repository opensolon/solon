...
| Более быстрое развитие | Маленькое ядро, быстрый вход; Отладка перезагрузки в 5-10 раз быстрее     |
| Лучший опыт производства и развертывания | Упаковка на 50-90% меньше; Быстрее, быстрее, быстрее.     |
