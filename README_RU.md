...
<p align="center">
На 700% выше; 50% памяти; Запуск в 10 раз быстрее; Упакуйте на 90% меньше; Поддерживает java8 - java25 в то же время, когда нейтив работает.
<br/>
...
| Более широкий диапазон совместимости                       | Архитектура не java-ee; Поддерживает java8 - java25, graalvm native image                                               |
...
|                                                                             |                                                                 |
| [/opensolon/solon-maven-plugin](../../../../opensolon/solon-gradle-plugin) | Solon Maven ,Код плагина хранилища                              | 
