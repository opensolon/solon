...
##### 语言： русск | [中文](README.md)  | [English](README_EN.md) | [日本語](README_JP.md)
...
**Solon** — эффективная система разработки приложений Java; Открытая экология с собственными стандартными нормами интерфейса, включающими различные эко-плагины для решения различных потребностей; Удобно настраивать; Быстрое развитие:

* **Сдержанность, лаконичность, открытость, экология**
...
* Ни спринг, ни сервлет, ни джаваи. Открытость новой независимой экологии
