...
<p align="center">
	<strong>Java "новая" основа разработки приложений, сдержанная, лаконичная, эффективная, открытая, экологическая!</strong>
    <br/>
...
<p align="center">
    ...
    <a target="_blank" href='https://gitcode.com/noear/solon/star'>
		<img src="https://gitcode.com/noear/solon/star/badge.svg" alt="gitcode star"/>
	</a>
</p>
...
<p align="center">
На 300% выше; 50% памяти; Запуск в 10 раз быстрее; Упакуйте на 90% меньше; Поддерживает java8 - java22 в то же время, когда нейтив работает.
<br/>
...
| Более быстрое развитие | Мало кодов; Быстро! Отладка перезагрузится в 10 раз быстрее     |
