...
public class RenderManager implements Render {
    ...
    public static void register(Render render) {
        ...
        LogUtil.global().warn("View: load: " + render.getClass().getSimpleName());
        LogUtil.global().warn("View: load: " + render.getClass().getName());
    }
    ...
    public static void mapping(String suffix, Render render) {
        ...
        LogUtil.global().warn("View: mapping: " + suffix + "=" + render.getName());
    }
    ...
    public static void mapping(String suffix, String clzName) {
        ...
        LogUtil.global().warn("View: mapping: " + suffix + "=" + clzName);
    }
