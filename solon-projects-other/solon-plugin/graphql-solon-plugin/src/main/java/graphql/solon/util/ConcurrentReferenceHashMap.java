...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements
    ...
    public boolean remove(@Nullable Object key, final @Nullable Object value) {
        Boolean result = doTask(key,
                new Task<Boolean>(TaskOption.RESTRUCTURE_AFTER, TaskOption.SKIP_IF_EMPTY) {
                    @Override
                    protected Boolean execute(@Nullable Reference<K, V> ref,
    ...
    @Override
    public boolean replace(@Nullable K key, final @Nullable V oldValue,
        ...
        Boolean result = doTask(key,
                new Task<Boolean>(TaskOption.RESTRUCTURE_BEFORE, TaskOption.SKIP_IF_EMPTY) {
                    ...
                    protected Boolean execute(@Nullable Reference<K, V> ref,
                            @Nullable Entry<K, V> entry) {
                        if (entry != null && ObjectUtils
                                .nullSafeEquals(entry.getValue(), oldValue)) {
    ...
    protected final class Segment extends ReentrantLock {
        ...
        public <T> T doTask(final int hash, @Nullable final Object key, final Task<T> task) {
            ...
            try {
                ...
                Entries<V> entries = value -> {
                    ...
                    Reference<K, V> newReference = Segment.this.referenceManager
                            .createReference(newEntry, hash, head);
        ...
        protected final void restructureIfNecessary(boolean allowResize) {
            ...
            boolean needsResize =
                    allowResize && (currCount > 0 && currCount >= this.resizeThreshold);
        ...
        private void restructure(boolean allowResize, @Nullable Reference<K, V> ref) {
            ...
            try {
                ...
                // will be purged
                needsResize = (countAfterRestructure > 0
                        && countAfterRestructure >= this.resizeThreshold);
    ...
    protected static final class Entry<K, V> implements Map.Entry<K, V> {
        ...
        public final int hashCode() {
            return (ObjectUtils.nullSafeHashCode(this.key) ^ ObjectUtils
                    .nullSafeHashCode(this.value));
        }
    }
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(@Nullable Object o) {
            if (o instanceof Map.Entry<?, ?>) {
                ...
                Reference<K, V> ref = ConcurrentReferenceHashMap.this
                        .getReference(entry.getKey(), Restructure.NEVER);
