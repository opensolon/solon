...
public class Param2AnnoController {
    ...
    @Mapping("header")
    public Object test_pm_header(@Param(header = "X-Name") String name) throws IOException {
        return name;
    }
    ...
    @Mapping("attr")
    public Object test_pm_attr(@Param(attr = "name") String name, @Param(attr = "_num") Integer num) throws IOException {
        return name + num;
    }
}
