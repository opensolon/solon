...
|      | solon-cloud::                     |   |                                 |
|      | - `solon.cloud.@@.event.username` |   | solon.cloud.@@.username         |
|      | - `solon.cloud.@@.event.password` |   | solon.cloud.@@.password         |
|      | - `solon.cloud.@@.event.accessKey` |   | solon.cloud.@@.accessKey        |
|      | - `solon.cloud.@@.event.secretKey` |   | solon.cloud.@@.secretKey        |
|      | - `solon.cloud.@@.file.username` |   | solon.cloud.@@.username         |
|      | - `solon.cloud.@@.file.password` |   | solon.cloud.@@.password         |
|      | - `solon.cloud.@@.file.accessKey` |   | solon.cloud.@@.accessKey        |
|      | - `solon.cloud.@@.file.secretKey` |   | solon.cloud.@@.secretKey        |
