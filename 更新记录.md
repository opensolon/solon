...
* 1.putStream 更新为 put
* 2.getStream 更名为 get
* 3.添加 minio-solon-plugin 插件
* 4.添加 health-checker-solon-plugin 插件
* 5.CloudLoadBalanceFactory 添加 register 接口（用于本地注册）
* 6.将本地服务发现，改为可与云端发现并存，并优于云端发现
* 7.修复 water HandlerCheck 无法获取网关数据的问题
* 8.org.noear.solon.cloud.tool 更名为 org.noear.solon.cloud.utils.http
* 9.CloudFileService 的 getStream 更名为 get，putStream 更名为 put
* 10.CloudFileService 改用 Media 做为交换媒介
