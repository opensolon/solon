...
* 2.添加 health-checker-solon-plugin 插件
* 3.CloudLoadBalanceFactory 添加 register 接口（用于本地注册）
* 4.将本地服务发现，改为可与云端发现并存，并优于云端发现
* 5.修复 water HandlerCheck 无法获取网关数据的问题
* 6.org.noear.solon.cloud.tool 更名为 org.noear.solon.cloud.utils.http
* 7.重新设计 CloudFileService 接口:get,put,delete
