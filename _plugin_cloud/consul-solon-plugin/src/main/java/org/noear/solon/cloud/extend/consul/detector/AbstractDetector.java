...
public abstract class AbstractDetector implements Detector{
    ...
    protected static String formatByteSize(long byteSize) {
        ...
        if (dataSize >= ONE_EB)
            return String.valueOf(Math.round(dataSize / ONE_EB * 100.0D) / 100.0D) + "EB";
        if (dataSize >= ONE_PB)
            return String.valueOf(Math.round(dataSize / ONE_PB * 100.0D) / 100.0D) + "PB";
        if (dataSize >= ONE_TB)
            return String.valueOf(Math.round(dataSize / ONE_TB * 100.0D) / 100.0D) + "TB";
        if (dataSize >= ONE_GB)
            return String.valueOf(Math.round(dataSize / ONE_GB * 100.0D) / 100.0D) + "GB";
        if (dataSize >= ONE_MB)
            return String.valueOf(Math.round(dataSize / ONE_MB * 100.0D) / 100.0D) + "MB";
        if (dataSize >= ONE_KB)
            return String.valueOf(Math.round(dataSize / ONE_KB * 100.0D) / 100.0D) + "KB";
        if (dataSize > 0.0D) {
            return String.valueOf(Math.round(dataSize)) + "B";
        }
        return "0";
    }
}
